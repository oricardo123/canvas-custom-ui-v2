    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 place-items-center gap-10 p-5">
        ...
        <Link
          ...
          target="_blank"
        >
          <Image src={hotelBristol} height={35} width={250} />
        </Link>
        <Link
          ...
          target="_blank"
        >
          <Image src={hotelMiragem} height={45} width={250} />
        </Link>
        <Link href="https://lebilboquetdallas.com/" target="_blank">
          <Image src={leBilloquet} height={35} width={250} />
        </Link>
        <Link href="https://lpmrestaurants.com/london/" target="_blank">
          <Image src={lpm} height={50} width={150} />
        </Link>
        <Link
          ...
          target="_blank"
        >
          <Image src={maisonBerguet} height={35} width={250} />
        </Link>
        <Link
